...
module.exports.main = function (ffCollection, vvClient, response) {
    /*Script Name:   UserMgmtUpdateAll
     Customer:      VV Code Example.
     Purpose:       The purpose of this script is to update all available user account fields by calling LibUserUpdate
    ...
    logger.info('Start of the process UserMgmtUpdateAll at ' + Date());
    ...
    var emailAddress = 'kendra.austin+DevTest1220106@visualvault.com';      //This may come from an email address field or be passed in another way.
