...
if (validationResults == true) {
    ...
    var messageData = 'You have indicated that this user account should be disabled. If you continue, this user will no longer be able to log in. Click OK to continue or Cancel to keep the user account enabled.';
